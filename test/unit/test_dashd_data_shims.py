...
# TODO: remove fixtures below here once test_SHIM_serialise_for_gentariumd removed
...
@pytest.fixture
def gentariumd_superblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_gentariumd(sentinel_proposal_hex, sentinel_superblock_hex):
    assert gentariumlib.SHIM_serialise_for_gentariumd(sentinel_proposal_hex) == ''
    assert gentariumlib.SHIM_serialise_for_gentariumd(sentinel_superblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.gentariumcentral.org/black-pearl',
